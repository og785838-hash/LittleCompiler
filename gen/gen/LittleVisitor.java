...
public interface LittleVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link LittleParser#break_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBreak_stmt(LittleParser.Break_stmtContext ctx);
	/**
	 * Visit a parse tree produced by {@link LittleParser#continue_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitContinue_stmt(LittleParser.Continue_stmtContext ctx);
	/**
